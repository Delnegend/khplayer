...
const KHPGlobal = {
  ...
  addingCSSandStuffs: async () => {
    let
      ...
      scriptNstyle = {
        "plyrCSS": "https://cdn.jsdelivr.net/gh/sampotts/plyr@3.5.10/dist/plyr.css",
        "plyrCSS_SHA": "wYjPR5w1allq5CQRlbeEZs5ZwlZf0RcOmTpihZoo3/x4peYWS8Xy7WeLViL+p9d3",
        "KHPlayerCSS": "https://cdn.jsdelivr.net/gh/DELNEGEND/KHPlayer@1.0/cdn/KHPlayer.min.css",
  ...
  KHPChangeEpisode: async elem => {
    ...
    KHPGlobal['KHPforPlyrToInteract' + uniqueKey][0].source = KHPGlobal["KHPPlaylist" + uniqueKey][index];
  },
